...
pub fn render_controls(
    ...
    let controls_line = Line::from(vec![
        ...
        Span::raw("  "),
        Span::styled(
            "[q]uit  [?]help  [Tab]focus  [n]ext  [p]rev  [s]huffle  [r]epeat  [space]play/pause  [Shift+F]search  [Shift+D]download selected song  [Alt+Shift+D]download selected playlist",
